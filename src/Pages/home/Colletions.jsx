...
const Colletions = () => {
    return (
        <div className='bg-[url("/src/assets/collection-bg.png")] bg-cover bg-center bg-no-repeat xl:px-28 px-4 my-20'>
            <div className="h-[580px] flex justify-between md:flex-row items-center">
                <div className="w-1/2"></div>
                <div className="w-1/2">
                    <img src="/src/assets/1024px-Zara_Logo 2.png" alt="zara logo" />
