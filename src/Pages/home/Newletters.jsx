  ...
  return (
    <div className="bg-[#1E2832] bg-opacity-5 xl:px-28 px-4 py-16">
        ...
        <div className="flex flex-wrap gap-4 items-center justify-center mb-20">
            <Link to={"/"}>
                <img src="/public/img1.png" alt="image 1" />
            </Link>
            <Link to={"/"}>
                <img src="/public/img2.png" alt="image 2" />
            </Link>
            <Link to={"/"}>
                <img src="/public/img3.png" alt="image 3" />
            </Link>
            <Link to={"/"}>
                <img src="/public/img4.png" alt="image 4" />
            </Link>
            <Link to={"/"}>
                <img src="/public/img5.png" alt="image 5" />
            </Link>
            <Link to={"/"}>
                <img src="/public/img6.png" alt="image 6" />
            </Link>
        </div>
